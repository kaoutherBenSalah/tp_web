...
--
CREATE DATABASE IF NOT EXISTS `tp_web` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `P_Satus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
